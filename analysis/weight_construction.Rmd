...
saveRDS(GRN_prob, "output/040722/binding_affinities_matrixRider_dbTF.rds")
```
...
```{r}
GRN_prob <- readRDS("output/040722/binding_affinities_matrixRider_dbTF.rds")
...
write_csv(GRN_final, "output/040722/GRN_weighted_040722.csv")
```
