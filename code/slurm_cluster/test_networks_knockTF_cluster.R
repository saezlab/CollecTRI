...
knockTF_exp_net <- rep(c("data/bench/knockTF_expr_NTNU_v1.rds",
                         "data/bench/knockTF_expr_NTNU_v2.rds",
                         "data/bench/knockTF_expr_NTNU_v2_dbTF.rds"), each = 4)
knockTF_meta_net <- rep(c("data/bench/knockTF_meta_NTNU_v1.rds",
                          "data/bench/knockTF_meta_NTNU_v2.rds",
                          "data/bench/knockTF_meta_NTNU_v2_dbTF.rds"), each = 4)
...
saveRDS(estimate@bench_res, paste0(output_path, "/estimate_knockTF_signed_test_networks.rds"))
