...
rna_exp_net <- rep(c("data/bench/rna_expr_NTNU_v1.rds",
                         "data/bench/rna_expr_NTNU_v2.rds",
                         "data/bench/rna_expr_NTNU_v2_dbTF.rds"), each = 4)
rna_meta_net <- rep(c("data/bench/rna_meta_NTNU_v1.rds",
                          "data/bench/rna_meta_NTNU_v2.rds",
                          "data/bench/rna_meta_NTNU_v2_dbTF.rds"), each = 4)
...
saveRDS(estimate@bench_res, paste0(output_path, "/estimate_rna_signed_test_networks.rds"))
