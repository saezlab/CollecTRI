...
networks <- network_collection$ExTRI_sign_unrestricted
...
knockTF_exp_net <- rep("data/bench/knockTF_expr_NTNU_v2_unres.rds", nrow(input_tibble)-2)
knockTF_meta_net <- rep("data/bench/knockTF_meta_NTNU_v2_unres.rds", nrow(input_tibble)-2)
...
saveRDS(estimate@bench_res, paste0(output_path, "/estimate_knockTF_test_sign_th_unres.rds"))
