...
rna_exp_net <- rep("data/bench/rna_expr_NTNU_v2_unres.rds", nrow(input_tibble)-2)
rna_meta_net <- rep("data/bench/rna_meta_NTNU_v2_unres.rds", nrow(input_tibble)-2)
...
saveRDS(estimate@bench_res, paste0(output_path, "/estimate_rna_test_sign_th_unres.rds"))
